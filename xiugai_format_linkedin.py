...
def test_xiugai():
	...
	while True:
		db_cursor = src_conn.find({"source": "Linkedin"}).skip(page_size*page).limit(page_size)

		page += 1
		temp = 0
		for d in db_cursor:
			resume = {"resume_id": "", "cv_id": "", "phone": "", "name": "", "email": "", "create_time": long(0),
					  "crawled_time": long(0), "update_time": "", "resume_keyword": "", "resume_img": "", "resume_url": "",
					  ...
					  "last_enterprise_industry": "", "website": "", "twitter": "",
					  ...
					  "flag": "0", "dimension_flag": False, "version": [], "keyword_id": [],"follows": [], "publicationList": [],
			...
			if "publicationList" not in resume:
